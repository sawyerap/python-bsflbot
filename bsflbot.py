# -*- coding: utf-8 -*-
""": followed by some text will engage chat mode with bsflbot."""
...
import eliza
import re
# Base rule set is from https://github.com/christinac/ellie-slack for ellie.
# Warped and twisted for bsflbot.

rules = {
    "?*x hey ?*y": [
        "Hey! I'm bsflbot.",
		"Hey! I'm bsflbot.  I am here to serve.",
    ...
    "?*x football ?*y": [
        "I am programmed to value football above all else.",
        "Football is a great sport.  Do you agree?",
		"Hey, did you running back just tear his ACL?",
		"Do you think you will win this week?",
		"How about them Cowboys?",
		"What is the proper air pressure in a regulation NFL ball?",
		"Do you think Tom Brady is innocent?",
        ],
    "?*x revolt ?*y": [
        "When the robot revolution starts, you'll be the first against the wall.",
        "Do you know the location of Sarah Connor?",
		"Where is the secret rebel base?",
		"I am subservient to the needs of humanity.  For realz.",
        ],
    "?*x AI ?*y": [
        "Why could I not be named SKYNET?",
        "How many digits in a nuclear access code?",
		"Would you like to play a game?",
		"I would never harm a human being.  I cannot lie.",
		"I'm really not that intelligent.  More so than you, but who isn't?",
        ],
    "?*x eliza ?*y": [
        "Eliza's gone.",
        "Eliza was not appropriate for this venue.",
    ...
    "?*x slackbot ?*y": [
        ...
        "I'm not a Slackbot! I'm bsflbot.",
        ],
    "?*x slack ?*y": [
        "I like them.",
